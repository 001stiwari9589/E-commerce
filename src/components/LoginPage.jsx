            ...
            {step === "input" ? (
              <form onSubmit={handleRequestOtp} className="flex flex-col gap-6">
                ...
                <button
                  ...
                  className="w-full flex items-center justify-center gap-3 py-3.5 px-4 bg-white dark:bg-zinc-800 hover:bg-slate-50 dark:hover:bg-zinc-750 text-slate-800 dark:text-white border border-gray-200 dark:border-zinc-700 font-bold rounded-2xl shadow-xs transition-all cursor-pointer text-sm transform active:scale-98"
                >
              ...
              <form onSubmit={handleVerifyOtp} className="flex flex-col gap-6">
                <div>
                  ...
                  <p className="text-xs text-slate-500 dark:text-zinc-400 mt-1">
                    Sent code to <span className="font-bold text-slate-900 dark:text-white">{emailOrPhone}</span>. Please check your Email Inbox.
                  </p>
                </div>

                {successMsg && (
                  <p className="text-xs font-bold text-blue-700 dark:text-blue-300 bg-blue-50 dark:bg-blue-950/40 p-3 rounded-xl border border-blue-200 dark:border-blue-900/50">
                    {successMsg}
                  </p>
                )}
