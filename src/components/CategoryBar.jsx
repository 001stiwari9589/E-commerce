function CategoryBar({ activeCategory, setActiveCategory }) {
  ...
  return (
    <div className="bg-white dark:bg-zinc-900 border-b border-gray-100 dark:border-zinc-800 shadow-sm py-4 px-4 overflow-x-auto no-scrollbar flex items-center justify-between md:justify-center md:gap-14 transition-colors">
      {categories.map((cat) => {
        ...
        return (
          <button
            ...
            className={`flex flex-col items-center gap-1.5 min-w-[75px] cursor-pointer group transition-all duration-300 ${
              isActive
          ...
          >
            <div
              className={`p-2 rounded-full transition-colors ${
                isActive
                  ? "bg-blue-50 dark:bg-amber-500/10"
