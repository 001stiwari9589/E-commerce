        ...
        <div className="max-w-7xl mx-auto w-full flex flex-col lg:flex-row items-center justify-between gap-3 sm:gap-4 lg:gap-8">
          ...
          <div className="hidden lg:flex items-center gap-6 shrink-0">
            ...
            <button
              ...
              className={`text-xs sm:text-sm font-extrabold cursor-pointer transition-all py-1 px-2.5 rounded-lg flex items-center gap-1 ${
                view === "admin"
                  ? "bg-amber-400 text-blue-950 font-black shadow-md"
                  : "bg-amber-500/20 text-amber-300 hover:bg-amber-500/30 hover:text-yellow-200 border border-amber-400/40"
              }`}
              title="ST Mart Owner Admin Panel"
            >
              <span>👑 Admin</span>
            </button>
            ...
            <div className="max-w-xl mx-auto bg-blue-700/95 dark:bg-zinc-900/95 backdrop-blur-md border border-white/15 dark:border-zinc-800 rounded-3xl p-5 shadow-2xl text-white flex flex-col gap-4 animate-slide-down">
              ...
              <div className="grid grid-cols-2 gap-2.5 text-xs font-bold">
                ...
                <button
                  ...
                  className={`flex items-center gap-2.5 p-3.5 rounded-2xl transition-all text-left cursor-pointer ${
                    view === "admin" ? "bg-amber-400 text-blue-950 font-black shadow-md" : "bg-amber-500/20 text-amber-300 hover:bg-amber-500/30 border border-amber-400/40"
                  }`}
                >
