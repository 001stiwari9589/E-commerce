...
function Navbar({
  ...
  return (
    <>
      <nav className="bg-blue-600 dark:bg-zinc-950 text-white sticky top-0 z-40 shadow-md transition-colors px-4 py-3 lg:py-2.5">
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-3 lg:gap-8">

          {/* Top Line: Brand & Action Buttons (Visible hamburger toggle on screens < 1024px / lg) */}
          <div className="w-full flex items-center justify-between lg:w-auto shrink-0">
            ...
            >
              <span className="text-xl lg:text-2xl font-black italic tracking-wide flex items-center gap-0.5 leading-none">
            ...
            <div className="flex items-center gap-2.5 lg:hidden">
              ...
              <button
                ...
                className={`relative p-1 rounded-full cursor-pointer transition-colors ${
              ...
              <button
                ...
                className={`px-3 py-1.5 rounded-xl font-black text-xs flex items-center gap-1.5 shadow-lg border transition-all active:scale-95 cursor-pointer ${
                  isMobileMenuOpen
          ...
          {/* Desktop Buttons List (Shown on Desktop screens >= 1024px / lg) */}
          <div className="hidden lg:flex items-center gap-6 shrink-0">
            ...
            {userEmail ? (
              ...
              <button
                ...
                className={`font-bold text-sm px-6 py-1.5 rounded-md transition-colors cursor-pointer shadow-md ${
                  view === "login"
            ...
            <button
              onClick={() => setView("wishlist")}
              className={`relative flex items-center gap-1 text-sm font-bold cursor-pointer transition-colors ${
            ...
            <button
              onClick={() => setView("cart")}
              className={`relative flex items-center gap-1.5 font-bold cursor-pointer text-sm transition-colors ${
                view === "cart" ? "text-yellow-400" : "text-white hover:text-yellow-300"
              }`}
            >
        ...
        {isMobileMenuOpen && (
          <div className="lg:hidden bg-blue-700 dark:bg-zinc-900 border-t border-blue-500/60 dark:border-zinc-800 shadow-2xl transition-all animate-slide-down mt-3 -mx-4 px-4 py-4">
            <div className="max-w-7xl mx-auto flex flex-col gap-4">
              ...
              <div className="flex items-center justify-between pb-3 border-b border-blue-500/50 dark:border-zinc-800">
                {userEmail ? (
                  ...
                  <button
                    ...
                    className="bg-yellow-400 hover:bg-yellow-300 text-blue-950 font-black text-xs px-5 py-2.5 rounded-xl shadow cursor-pointer transition-colors"
                  >
                    Sign In / Register
                  </button>
                )}
              ...
              {/* Categories Drawer Quick Selector */}
              {setActiveCategory && (
                <div className="flex flex-col gap-1.5 pb-3 border-b border-blue-500/50 dark:border-zinc-800">
                  <span className="text-[11px] font-black tracking-wider text-yellow-300 uppercase">
                    Browse Categories
                  </span>
                      ...
                      <button
                        ...
                        className={`text-xs font-bold px-3 py-1.5 rounded-lg cursor-pointer transition-all ${
                          activeCategory === cat.id
                            ...
                            : "bg-blue-800/80 dark:bg-zinc-800 text-white hover:bg-blue-800"
                        }`}
                      >
                        {cat.name}
                      </button>
